                        ...
                        function(e) {
                            ...
                            if (a) {
                                ...
                                const e = document.body,
                                    ...
                                    a = e.clientWidth;
                                t.css({ ...!c && {
                                        width: s ? a - i.get(0).getBoundingClientRect().right : a
                                    },
                                    ...c && {
                                        width: s ? i.get(0).getBoundingClientRect().left : a
                                    },
                                    ...!c && {
                                        left: n.left - o.left
                                    },
    ...
    r.m = i, r.n = function(e) {
        ...
        function() {
            ...
            function T(e) {
                ! function(e) {
                    let {
                        element: t,
                        type: n
                    } = e, o = O(t.dataset.parallax), i = I(t), a = (window.innerHeight - i.offsetHeight) * o;
                    switch (n) {
                ...
                function(e) {
                    let {
                        element: t,
                        type: n
                    } = e, o = O(t.dataset.parallax || t.dataset.parallaxBackground), i = window.innerHeight, a = I(t), r = t.offsetHeight - a.offsetHeight, s = t.getBoundingClientRect(), l = a !== t ? a.getBoundingClientRect() : s, c = s.top + t.offsetHeight / 2, u = i / 2 - c, d = i / 2 - (l.top + a.offsetHeight / 2), h = c + _() < i / 2 ? _() : u, f = (Math.abs(u), Math.abs(h) / (i / 2)), p = 0;
                    var y;
            ...
            window.addEventListener("scroll", L, {
                passive: !0
            }), window.addEventListener("resize", L), new MutationObserver(L).observe(document.body, {
                childList: !0
            ...
            function W() {
                window.removeEventListener("keydown", W), window.removeEventListener("pointermove", W), window.removeEventListener("touchstart", W),
                    function() {
                        ...
                        n.addClass("stuck"), jQuery("body").append(t), V = Math.round(n.height()), t.remove(), window.flatsomeVars.stickyHeaderHeight = V,
                            function(e) {
                                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
            ...
            document.addEventListener("DOMContentLoaded", (() => {
                window.location.hash || window.scrollY > 200 ? W() : (window.addEventListener("keydown", W, {
                    once: !0
